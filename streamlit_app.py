...
fda_compound_names = sorted(df[df['FDA_Approved'] == True]['Compound_Name'].unique().tolist())
...
If you are using our database or the App please cite: Malikov, D., Krasnov, L., Kiseleva, M. et al. **Dataset of solubility values for organic compounds in binary mixtures of solvents at various temperatures**. Sci Data (2026). https://doi.org/10.1038/s41597-026-07047-z
